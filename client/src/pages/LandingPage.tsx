...
export const LandingPage: React.FC = () => {
  ...
  return (
    <div className="bg-clay text-earth-indigo min-h-screen selection:bg-vitality-coral selection:text-white overflow-x-hidden transition-colors duration-200">
      ...
      {/* 5. Trust & Verified Stay (Contrast Inverted: Dark in Light Mode, White in Dark Mode) */}
      <CinematicSection className="py-28 bg-[#1a1f2c] dark:bg-white text-white dark:text-[#1a1f2c] px-6 md:px-12 relative overflow-hidden transition-colors duration-200">
