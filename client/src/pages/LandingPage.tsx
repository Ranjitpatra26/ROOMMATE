...
import { ScrollReveal } from '../components/motion/index.js';
...
export const LandingPage: React.FC = () => {
  ...
  return (
    <div className="bg-clay text-earth-indigo min-h-screen selection:bg-vitality-coral selection:text-white transition-colors duration-200">
      ...
      {/* 3. Narrative Section (The Living OS Manifesto) */}
      <section className="py-28 px-6 md:px-12 max-w-7xl mx-auto border-t border-surface-dim/40">
      ...
      {/* 4. Lifestyle Architecture Section (Habitat Calibration) */}
      <section className="py-28 bg-surface-low px-6 md:px-12 border-y border-surface-dim/40">
      ...
      {/* 5. Compatibility Section (The Algorithm of Living) */}
      ...
      {/* 6. Trust & Verified Stay (Contrast Inverted: Dark in Light Mode, White in Dark Mode) */}
      <section className="py-28 bg-[#1a1f2c] dark:bg-white text-white dark:text-[#1a1f2c] px-6 md:px-12 relative overflow-hidden transition-colors duration-200">
        <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-vitality-coral/15 dark:bg-vitality-coral/10 rounded-full blur-3xl pointer-events-none transform translate-x-1/3 -translate-y-1/3" />
        <div className="max-w-7xl mx-auto relative z-10 text-center space-y-6">
          <ScrollReveal direction="up">
            <span className="font-sans text-label-caps text-vitality-coral uppercase tracking-widest block font-bold">
              Integrity by Design
            </span>
            <h2 className="font-serif text-headline-lg-mobile md:text-headline-lg text-white dark:text-[#1a1f2c] font-bold">
              Peace of mind, built in.
            </h2>
            <p className="font-sans text-body-lg text-white/80 dark:text-[#525763] max-w-2xl mx-auto leading-relaxed">
            ...
            <ScrollReveal direction="right">
              ...
              >
                <img
                  ...
                  loading="lazy"
                />
                <div className="absolute bottom-6 right-6 bg-clay/90 dark:bg-earth-container/90 backdrop-blur-md px-4 py-2 rounded-lg shadow-lg flex items-center gap-2 border border-surface-dim text-earth-indigo font-sans text-ui-medium font-semibold">
      ...
      {/* 8. Match Reveal Equation (Resonance Metric) */}
      <section className="py-28 bg-surface-low text-center px-6 border-t border-surface-dim/40">
        <Container size="md">
          <ScrollReveal direction="up">
      ...
      <section className="py-32 px-6 text-center relative overflow-hidden bg-clay">
