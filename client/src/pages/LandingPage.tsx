...
export const LandingPage: React.FC = () => {
  ...
  return (
    <div className="bg-clay text-earth-indigo min-h-screen selection:bg-vitality-coral selection:text-white overflow-x-hidden transition-colors duration-200">
      {/* 1. Hero Masthead with 3D Canvas */}
      <header className="relative min-h-screen flex flex-col justify-center items-center pt-24 px-6 overflow-hidden">
        ...
        <div className="absolute inset-0 w-full h-full pointer-events-none z-0 opacity-50 md:opacity-65">
          <Canvas
      ...
      {/* 2. Narrative Section (5 / 7 Asymmetric Editorial Composition) */}
          ...
          <div className="md:col-span-7">
            <ScrollReveal direction="right">
              <CursorTilt maxTilt={4}>
                <div className="relative w-full aspect-[4/3] rounded-2xl overflow-hidden shadow-2xl border border-surface-dim/50">
                  <img
      ...
      {/* 3. Lifestyle Architecture Section */}
      ...
      {/* 4. Compatibility Section (Orbital Visualization) */}
      ...
      {/* 5. Trust & Verified Stay (Authoritative Earth Indigo Surface) */}
      <section className="py-28 bg-earth-indigo text-clay px-6 md:px-12 relative overflow-hidden">
          ...
          <div className="lg:col-span-8">
            <ScrollReveal direction="right">
              <CursorTilt maxTilt={4}>
                <div
                  onClick={() => navigate('/rooms/the-indiranagar-studio')}
                  className="relative w-full aspect-video rounded-2xl overflow-hidden shadow-2xl border border-surface-dim cursor-pointer group"
                >
                  <img
                    ...
                    loading="lazy"
                  />
                  <div className="absolute bottom-6 right-6 bg-clay/90 backdrop-blur-md px-4 py-2 rounded-lg shadow-lg flex items-center gap-2 border border-surface-dim text-earth-indigo font-sans text-ui-medium font-semibold">
