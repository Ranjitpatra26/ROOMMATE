...
export const SpatialCityPage: React.FC = () => {
  ...
  return (
    <LiveLocationProvider>
      ...
      <div className="absolute top-5 left-1/2 -translate-x-1/2 z-overlay flex items-center gap-1.5 p-1 bg-[#fcf8fa] dark:bg-[#1e2433] border border-[#dcd9db] dark:border-white/20 rounded-full shadow-2xl pointer-events-auto">
        <button
          type="button"
