...
export const LiveLocationControlPanel: React.FC = () => {
    ...
    return (
      <div className="absolute bottom-6 right-4 md:bottom-8 md:right-8 z-20 pointer-events-auto text-left">
        <button
          ...
          className="px-3.5 py-2 bg-white/45 dark:bg-black/45 backdrop-blur-xl border border-white/40 dark:border-white/15 rounded-full shadow-md flex items-center gap-2 font-sans text-xs font-bold text-[#0f172a] dark:text-white hover:border-vitality-coral transition-all cursor-pointer"
  ...
  return (
    <div className="absolute bottom-6 right-4 md:bottom-8 md:right-8 z-20 w-[calc(100vw-2rem)] max-w-xs sm:max-w-sm md:w-80 bg-white/60 dark:bg-black/60 backdrop-blur-2xl border border-white/40 dark:border-white/15 rounded-3xl p-4 shadow-2xl space-y-3 animate-in fade-in zoom-in-95 duration-200 pointer-events-auto text-left">
