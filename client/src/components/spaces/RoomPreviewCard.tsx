...
export const RoomPreviewCard: React.FC<RoomPreviewCardProps> = ({
  ...
  return (
    <>
      ...
      <div className="md:hidden fixed inset-x-0 bottom-0 z-40 bg-[#fcf8fa]/95 dark:bg-[#1e2433]/95 backdrop-blur-2xl border-t border-[#dcd9db]/60 dark:border-white/20 rounded-t-3xl p-5 shadow-2xl space-y-4 animate-in slide-in-from-bottom duration-300 pointer-events-auto">
        {/* Dismiss drag handle */}
