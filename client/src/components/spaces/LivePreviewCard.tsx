...
export const LivePreviewCard: React.FC<LivePreviewCardProps> = ({ liveItem, onClose }) => {
  ...
  return (
    <>
      {/* Mobile Bottom Sheet */}
      <div className="md:hidden fixed inset-x-0 bottom-0 z-40 spatial-glass-card rounded-t-3xl p-5 space-y-4 animate-in slide-in-from-bottom duration-300 pointer-events-auto text-left">
