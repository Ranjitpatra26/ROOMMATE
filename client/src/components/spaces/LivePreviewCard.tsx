...
export const LivePreviewCard: React.FC<LivePreviewCardProps> = ({ liveItem, onClose }) => {
  ...
  return (
    <>
      {/* Mobile Bottom Sheet */}
      <div className="md:hidden fixed inset-x-0 bottom-0 z-40 bg-clay/95 dark:bg-earth-container/95 backdrop-blur-2xl border-t border-surface-dim dark:border-white/20 rounded-t-3xl p-5 shadow-2xl space-y-4 animate-in slide-in-from-bottom duration-300 pointer-events-auto text-left">
