...
export const NearbyDrawer: React.FC<NearbyDrawerProps> = ({
  ...
  return (
    <div className="absolute top-24 left-6 md:left-8 z-50 max-w-sm sm:max-w-md w-full bg-clay/95 dark:bg-earth-container/95 backdrop-blur-2xl border border-surface-dim dark:border-white/20 rounded-3xl p-5 shadow-2xl space-y-4 animate-in fade-in slide-in-from-top-4 duration-200 pointer-events-auto text-left">
      {/* Header */}
